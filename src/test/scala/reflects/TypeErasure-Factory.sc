...
object JobFactory {
  val BasicJobType = classTag[BasicJob]
  ...
  def detectAndCreateJob[T](jobName: String, dbReader: DbReader, classType: Object) = {
    classType match {
...
val blueJob = JobFactory.readFromOracle[BlueJob]("1234")
blueJob.BLUE_FIELD_1
blueJob.dbReader.getConnection
blueJob.COLOUR_FIELD
